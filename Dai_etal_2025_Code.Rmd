...
```{r}
setwd('~/Downloads/inorganic_exposures_sociodemographic-main/')
...
View final PWS & County dataframes.
Join adjusted PWS & County dataframes into 1 dataframe.
```{r}
As_PWScounty_binom_df1
Cr_PWScounty_binom_df1
Mn_PWScounty_binom_df1
Se_PWScounty_binom_df1

As_PWScounty_nonz_df1 
Cr_PWScounty_nonz_df1 
Mn_PWScounty_nonz_df1 
Se_PWScounty_nonz_df1 
